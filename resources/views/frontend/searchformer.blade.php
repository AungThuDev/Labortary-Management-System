...
<section class="members">
    <div class="container">
        ...
        <div class="col-2" style="margin-top: 30px;">
                    <a href="{{route('former-members')}}" class="btn btn-outline-success" style="border-radius: 50%;"><i class="fas fa-arrow-left"></i></a>
                </div>
            <div class="col-8">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 card-advisor">
                                <div class="card img-card">
                                    <img src="{{asset('storage/memberimages/'.$member->image)}}" class="card-img-top img-top" alt="Former Members of Innovative Lab">
                                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                <div class="container">
                                    <div class="card p-4">
                                        <div class="text">
                                            <h6><a href="{{route('members')}}">Active Members</a></h6>
                                            <hr>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <img src="{{asset('storage/memberimages/'.$member->image)}}" width="60" height="70" alt="Active Members of Innovative Lab">
                                            </div>
                                            <div class="col-8">
                                                <h6>{{$member->name}}</h6>
