        ...
        <div class="container">
            <div class="row">
                <div class="col-2" style="margin-top: 30px;">
                    <a href="{{route('members')}}" class="btn btn-outline-success" style="border-radius: 50%;"><i class="fas fa-arrow-left"></i></a>
                </div>
                <div class="col-8">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-12">
                                    <div class="container">
                                        <div class="card p-4">
                                            <div class="text">
                                                <h6><a href="{{route('former-members')}}">Former Members</a></h6>
                                                <hr>
                                            </div>
