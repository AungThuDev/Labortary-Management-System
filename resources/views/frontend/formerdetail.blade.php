...
@section('link','Former Members')
@section('head','Former Members Detail')
@section('content')
...
<section class="members">
    <div class="container">
        <div class="row">
            ...
            <div class="col-10">
                <h2 style="margin-right: 220px;" class="member_header">Former Members</h2>
            </div>
            <div class="col-2"></div>
            <div class="col-12">
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 card-advisor">
                                <div class="card img-card">
                                    <img src="{{asset('storage/memberimages/'.$member->image)}}" style="width:300px;height:300px;" class="card-img-top img-top" alt="Former Members of Innovative Lab">
                                    <hr>
                                    <div class="card-body">
                                        <div class="row">
