        ...
        <form action="{{route('admin.subjects.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-6 form-group">
                    ...
                    <input type="text" name="instructor_name" class="form-control @error('instructor_name') is-invalid @enderror" value="{{old('instructor_name')}}">
                ...
                <div class="col-6 form-group">
                    ...
                    <input type="text" name="instructor_email" class="form-control @error('instructor_email') is-invalid @enderror" value="{{old('instructor_email')}}">
            ...
            <div class="row">
                ...
                <div class="col-6 form-group">
                    ...
                    <input type="text" name="web_page" class="form-control @error('web_page') is-invalid @enderror" value="{{old('web_page')}}">
                    @error('web_page')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="row">
                <div class="col-6 form-group">
                    ...
                    <input type="text" name="instructor_office" class="form-control @error('instructor_office') is-invalid @enderror" value="{{old('instructor_office')}}">
                ...
                <div class="col-6 form-group">
                    ...
                    <input type="text" name="office_hour" class="form-control @error('office_hour') is-invalid @enderror" value="{{old('office_hour')}}">
                    @error('office_hour')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
